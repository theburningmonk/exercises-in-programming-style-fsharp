...
let website = "/exercises-in-programming-style-fsharp"

let githubLink = "http://github.com/theburningmonk/exercises-in-programming-style-fsharp"

// Specify more information about your project
let info =
  [ "project-name", "exercises-in-programming-style-fsharp"
    "project-author", "theburningmonk"
    "project-summary", "F# port of the examples in \"Exercises in Programming Style\""
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/exercises-in-programming-style-fsharp" ]
